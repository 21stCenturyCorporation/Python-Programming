    ...
    if entry1.isalpha() or entry2.isalpha() or entry3.isalpha() or entry4.isalpha():
        try:
            if entry1.casefold() == "A".casefold():
                ...
                credit_1["text"] = "0"
            elif entry1.casefold() != "A".casefold() or entry1.casefold() != "B".casefold() or entry1.casefold() != "C".casefold() or entry1.casefold() != "D".casefold() or entry1.casefold() != "E".casefold() or entry1.casefold() != "F".casefold():
                raise ValueError
            ...
            elif entry2.casefold() != "A".casefold() or entry2.casefold() != "B".casefold() or entry2.casefold() != "C".casefold() or entry2.casefold() != "D".casefold() or entry2.casefold() != "E".casefold() or entry2.casefold() != "F".casefold():
                raise ValueError
            ...
            elif entry3.casefold() != "A".casefold() or entry3.casefold() != "B".casefold() or entry3.casefold() != "C".casefold() or entry3.casefold() != "D".casefold() or entry3.casefold() != "E".casefold() or entry3.casefold() != "F".casefold():
                raise ValueError
            ...
            if entry4.casefold() == "A".casefold():
                ...
                credit_4["text"] = "0"
            elif entry4.casefold() != "A".casefold() or entry4.casefold() != "B".casefold() or entry4.casefold() != "C".casefold() or entry4.casefold() != "D".casefold() or entry4.casefold() != "E".casefold() or entry4.casefold() != "F".casefold():
                raise ValueError
